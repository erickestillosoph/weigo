...
export const useValidationSchemaCreateAdminAccount = (values) => {
    const {
        name,
        email,
        password,
    ...
    const [passwordConfirmationData, setPasswordConfirmationData] =
        useState("undefined");
    ...
    const validateConfirmedPassword = () => {
        ...
        setPasswordConfirmationData(response);
        return response;
    };
